...
include('database.php');
 ...
 $sql = "SELECT * FROM `homepageslider` WHERE `id`= '$sid'";
...
<!-- Slider Section Start -->
 ...
 <form method="post" action="sliderSectionUpdateData.php" enctype="multipart/form-data">

                            <div class="row form-group">
								<div class="col-md-6">
								<!--	 <label for="titlename">Title Name</label> -->
									<input type="text" name="titlename" id="titlename" class="form-control" placeholder="Ex: Best Training Center of GIS" value = "<?php echo $data ['titlename']; ?>">
								</div>
								<div class="col-md-6">
							...
							<div class="form-group" style="text-align: right">	
								...
								<input type="submit" name="sliderSectionUpdate" value="Save Changes" class="btn btn-primary">  
