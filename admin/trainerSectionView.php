...
?>
 ...
 <form method="post" action="trainerSectionView.php" enctype="multipart/form-data">
<?php 
...
?>
                            <div class="row form-group">
								<div class="col-md-6">
									 <label for="EventName">Trainer Name</label>
									<p><?php echo $data ['TrainerName']; ?></p>
								</div>
								<div class="col-md-6">
		...
		<table align="center" width="20%" style="margin-top:10px;">
           <tr>
            <th><a href="trainerSectionUpdate.php?sid=<?php echo $data['id'];?>">Edit</a></th>
            <th><a href="trainerSectionDelete.php?sid=<?php echo $data['id'];?>">Delete</a></th>
           </tr>
        </table>
		  <hr>
