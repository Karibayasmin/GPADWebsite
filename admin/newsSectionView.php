		...
		<div id="colorlib-contact">
			<div class="container">
				...
				<div class="col-md-10 col-md-offset-1 animate-box">
                 <h2>NEWS Section</h2>
<form method="post" action="newsSectionView.php" enctype="multipart/form-data">
<?php 
...
?>
							...
							<div class="row form-group">
								<div class="col-md-6">
                                    ...
                                    <p><?php echo $data ['NewsHeadline']; ?></p>
								</div>
		...
		<table align="center" width="20%" style="margin-top:10px;">
           <tr>
            <th><a href="NewsSectionupdate.php?sid=<?php echo $data['id'];?>">Edit</a></th>
            <th><a href="NewsSectiondelete.php?sid=<?php echo $data['id'];?>">Delete</a></th>
           </tr>
        </table>
		  <hr>
