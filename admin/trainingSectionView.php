...
<!-- Traning Section Start -->
 ...
 <form method="post" action="trainingSectionView.php" enctype="multipart/form-data">
<?php 
...
?>
                        <div class="row form-group">
								<div class="col-md-6">
								    ...
								    <p/><?php echo $data ['TrainingName']; ?></p>
								</div>
		...
		<table align="center" width="20%" style="margin-top:10px;">
           <tr>
            <th><a href="trainingSectionupdate.php?sid=<?php echo $data['id'];?>">Edit</a></th>
            <th><a href="trainingSectiondelete.php?sid=<?php echo $data['id'];?>">Delete</a></th>
           </tr>
        </table>
		  <hr>
