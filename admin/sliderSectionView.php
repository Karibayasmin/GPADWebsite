...
<!-- Slider Section Start -->
 ...
 <form method="post" action="sliderSectionView.php" enctype="multipart/form-data">
<?php 
...
?>
		...
		<table align="center" width="20%" style="margin-top:10px;">
           <tr>
            <th><a href="sliderSectionupdate.php?sid=<?php echo $data['id'];?>">Edit</a></th>
            <th><a href="sliderSectiondelete.php?sid=<?php echo $data['id'];?>">Delete</a></th>
           </tr>
        </table>
		  <hr>
